...
function create() {
    $('#ajax-model-dialog-editor').attr("data-url", "/Representative/Create");
    $('#ajax-model-dialog-editor').click();
}

function edit(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Representative/Edit/" + id);
    $('#ajax-model-dialog-editor').click();
}

function remove(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Representative/Delete/" + id);
    $('#ajax-model-dialog-editor').click();
}
