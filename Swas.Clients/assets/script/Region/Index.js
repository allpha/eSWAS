...
function create() {
    $('#ajax-model-dialog-editor').attr("data-url", "/Region/Create");
    $('#ajax-model-dialog-editor').click();
}

function edit(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Region/Edit/" + id);
    $('#ajax-model-dialog-editor').click();
}

function remove(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Region/Delete/" + id);
    $('#ajax-model-dialog-editor').click();
}
