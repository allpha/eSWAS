...
function create() {
    $('#ajax-model-dialog-editor').attr("data-url", "/Reciever/Create");
    $('#ajax-model-dialog-editor').click();
}

function edit(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Reciever/Edit/" + id);
    $('#ajax-model-dialog-editor').click();
}

function remove(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Reciever/Delete/" + id);
    $('#ajax-model-dialog-editor').click();
}
