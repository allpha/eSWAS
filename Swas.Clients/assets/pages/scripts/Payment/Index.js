...
function initTableItemSource(itemSource) {
    ...
    for (var i = 0; i < itemSource.length; i++) {
        var row = '<tr>' +
                       ...
                       '<td >' +
                            '<a href="javascript:add(' + itemSource[i].ActId + ');" class="btn btn-xs default"><i class="fa fa-edit"></i></a>' +
                            '<a href="javascript:info(' + itemSource[i].ActId + ');" class="btn btn-xs default"><i class="icon-tag"></i></a>' +
                            '<a target="_blank" href="/SolidWasteActPrint/Index/' + itemSource[i].ActId + '" class="btn btn-xs default"><i class="fa fa-print"></i></a>' +
                       '</td>' +
                  '</tr>';
