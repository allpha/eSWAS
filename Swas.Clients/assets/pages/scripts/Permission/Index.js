...
function create() {
    $('#ajax-model-dialog-editor').attr("data-url", "/Permission/Create");
    $('#ajax-model-dialog-editor').click();
}

function edit(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Permission/Edit/" + id);
    $('#ajax-model-dialog-editor').click();
}

function remove(id) {
    $('#ajax-model-dialog-editor').attr("data-url", "/Permission/Delete/" + id);
    $('#ajax-model-dialog-editor').click();
}
